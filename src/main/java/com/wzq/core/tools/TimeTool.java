 ...
 * Date: 2015-12-04 12:30:29
 * Description: timetools
 */
public class TimeTool {
    ...
    public static int getNumOfMonth(String sDate, String sMonth) {
        ...
        if (sMonth.equals("1") || sMonth.equals("3") || sMonth.equals("5")
            ...
            return 31;
        else if (sMonth.equals("4") || sMonth.equals("6") || sMonth.equals("9")
                || sMonth.equals("11"))
            return 30;
        else if (iYear % 4 == 0) {
    ...
    public static String formatDate(String strDate) {
        ...
        try {
            ...
            if (strDate.indexOf(" ") != -1) {
                sdate += strDate.substring(strDate.indexOf(" "), strDate
                        .length() - 1);
            }
            return sdate;
        } catch (Exception e) {
    ...
    public static String MonthMove(String sDate, int iMonth) {
        ...
        java.util.GregorianCalendar thedate = new java.util.GregorianCalendar(
                iyear, imonth, iday);
    ...
    public static void main(String args[]) throws Exception{
        ...
        String time = "2011-4-23";
        System.err.println(TimeTool.dateMove(time, 280));
		/*SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String ss = getTimeStr(System.currentTimeMillis(), "yyyy-M-d H:m:s");
		System.err.println(ss);
		ss = getTimeStr(sdf.parse(ss).getTime());
		System.err.println(ss);


		System.err.println(getCurHour("2001-3-3 1:33:2"));

		String st = "2008-2-7 2:31:3";
		long time = getStrTime(st);
		System.err.println(getTimeStr(time));
		System.err.println(isRenYearByLong(time));
		System.err.println(isRenYear(st));
		if(true)
			return;

		time = setTime(time, -1, 1, 22, -1, 34, -1, -1);

		System.err.println(getTimeStr(time));
		if(true)
			return;

		time = setMonth(time, 4);
		System.err.println(getTimeStr(time));
		if(true)
			return;
		for(int i=0; i<12; i++)
			System.err.println(i / 3 * 3);*/
    }
